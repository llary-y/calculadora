...
public class Teclado extends JPanel implements ActionListener {
	...
	public Teclado() {
		...
		// linha 1
		c.gridwidth = 2;
		adicionarBotao("AC", COR_CINZA_ESCURO, c, 0, 0); // ocupa 2
		c.gridwidth = 1; // resto ocupa 1
		adicionarBotao("±", COR_CINZA_ESCURO, c, 2, 0); // mudança sinal
